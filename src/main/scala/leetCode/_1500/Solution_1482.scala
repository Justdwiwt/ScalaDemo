...
object Solution_1482 {
  ...
  private def f(bloomDay: Array[Int], m: Int, k: Int, left: Int, right: Int): (Int, Int, Int) = {
  ...
  private def isDayOkay(bloomDay: Array[Int], m: Int, k: Int, currDay: Int): Boolean = bloomDay./:((m, k)) {
    case ((0, _), _) => (0, 0)
