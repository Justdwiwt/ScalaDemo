...
object Solution_2718 {
  def matrixSumQueries(n: Int, queries: Array[Array[Int]]): Long = queries.foldRight(0L, Map.empty[Int, Int], Map.empty[Int, Int]) {
    case (Array(t, i, v), (res, rows, cols)) => (t, cols.get(i), rows.get(i)) match {
