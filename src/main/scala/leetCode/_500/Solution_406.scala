...
object Solution_406 {
  def reconstructQueue(people: Array[Array[Int]]): Array[Array[Int]] = {
    def f(sorted: Array[Array[Int]], value: Array[Array[Int]]): Array[Array[Int]] = sorted
      .headOption
      .map((person: Array[Int]) => {
    ...
    f(sorted = people.sortWith((p1, p2) => {
      if (p1.head < p2.head) true
      else if (p1.head == p2.head && p1(1) > p2(1)) true
      else false
