...
object Solution_1249 {
  private def removeIndices(string: String, stack: List[Int]): String = string
    .zipWithIndex
  ...
  private def f(string: List[(Char, Int)], stack: List[Int], store: List[Int], ori: String): String = string.headOption match {
